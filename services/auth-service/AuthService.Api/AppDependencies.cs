    ...
    public static class AppDependencies
    {
        public static IServiceCollection AddAppDependencies(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddAuthorization(options =>
            {
                ...
                options.AddPolicy("CreateLead", policy =>
                    policy.RequireClaim("Can Create Lead", "true")
                );

                options.AddPolicy("EditLead", policy =>
                    policy.RequireClaim("Can Edit Lead", "true")
                );

                options.AddPolicy("DeleteLead", policy =>
                    policy.RequireClaim("Can Delete Lead", "true")
                );

                options.AddPolicy("CreateAndEditLead", policy =>
                    policy.RequireClaim("Can Create Lead", "true")
                        .RequireClaim("Can Edit Lead", "true")
                );

                options.AddPolicy("AdminCanCreateLead", policy =>
                    policy.RequireClaim("Can Create Lead", "true")
                        .RequireRole("Admin")
                );
