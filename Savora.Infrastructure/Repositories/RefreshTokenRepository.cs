...
namespace Savora.Application.Repositories
{
    public class RefreshTokenRepository(SavoraContext context, ITokenGenerator tokenGenerator, ICookieManager cookieManager, ILogger<RefreshTokenRepository> logger) : IRefreshTokenRepository
    {
